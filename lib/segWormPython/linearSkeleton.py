...
"""
import numpy as np
from .cython_files.linearSkeleton_cython import chainCodeLength2Index, circOpposingNearestPoints, \
...
def getBendsSeeds(contour, bend_ind, chain_code_len, head_ind, tail_ind,
    ...
    bend2_s2 = bend_ind[(bend_ind >= tail_end) & (bend_ind <= head_start)]# maybe some error
